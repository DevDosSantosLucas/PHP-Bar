    ...
    <?php
        ...
        if ($db_connect->connect_error) {
            ...
            echo 'Conexão feita com sucesso' . '<br><br>';
                ...
                foreach($pratos as $prato){
                    ...
                    '$codigo','$nome','$categoria','$descr',
                    '$preco','$calorias','$destaque')";

                    if($db_connect ->query($sql)){
                        echo $nome. " inserido com sucesso!".'<br><br>';

                    } else{
                        echo  "Não foi possicel inser ". $nome . '<br><br>';
        ...
        // mysqli_query($db_connect,"CREATE database RESTAURANTE");

        // mysqli_query($db_connect,"CREATE TABLE RESTAURANTE (
